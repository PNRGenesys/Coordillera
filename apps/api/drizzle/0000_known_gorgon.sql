CREATE TYPE "public"."inventory_movement_type" AS ENUM('restock', 'adjustment', 'reservation', 'release', 'sale', 'return');--> statement-breakpoint
CREATE TYPE "public"."order_status" AS ENUM('pending_payment', 'paid', 'processing', 'fulfilled', 'shipped', 'delivered', 'cancelled', 'refunded');--> statement-breakpoint
...
CREATE UNIQUE INDEX "cart_variant_unique" ON "cart_items" USING btree ("cart_id","variant_id");